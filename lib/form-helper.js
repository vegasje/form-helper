		...
		return {
			validate: function() {
				...
				$.each(settings.fields, function(name, fieldSettings) {
					if (fieldSettings.state) {
						var states = fieldSettings.state($form);
						...
						$.each(states, function(i, state) {
							...
							if (fieldPass) {
								fieldSettings.onPass.apply($form);
							} else {
								fieldSettings.onFail.apply($form);
							}
			...
			currentState: function() {
				...
				$.each(settings.fields, function(name, fieldSettings) {
					...
					} else if (fieldSettings.state) {
						state[name] = fieldSettings.state($form);
					}
				});
